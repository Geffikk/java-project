...
public interface iAutobus {
    ...
    void clearDepartures(Label label, Label label2, javafx.scene.shape.Line traceOfStops, Pane pane, Pane content);
     ...
     * @param traceOfStops -> represent trace of stops
     * @param content -> root pane */
    void setDepartures(Label label, Label label2, javafx.scene.shape.Line traceOfStops, Pane content);
